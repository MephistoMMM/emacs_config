...
(let ((gruvbox-dark0_hard  (if (display-graphic-p) "#1d2021" "color-234"))
  ...
  (custom-theme-set-faces
    ...
    `(font-lock-function-name-face      ((t (:foreground ,gruvbox-bright_yellow))))
    ...
    `(whitespace-trailing               ((t (:background ,gruvbox-dark1 :foreground ,gruvbox-bright_red))))
    `(whitespace-line                   ((t (:background ,gruvbox-dark1 :foreground ,gruvbox-bright_red))))
    ...
    `(sp-show-pair-mismatch-face        ((t (:background ,gruvbox-bright_red)))) ;; Highlight for bracket without pair

    ;; elscreen
    `(elscreen-tab-background-face      ((t (:box nil :background ,gruvbox-dark0)))) ;; Tab bar, not the tabs
    `(elscreen-tab-control-face         ((t (:box nil :background ,gruvbox-dark2 :foreground ,gruvbox-bright_red :underline nil)))) ;; The controls
    ...
    `(ag-hit-face                       ((t (:foreground ,gruvbox-bright_blue))))
    `(ag-match-face                     ((t (:foreground ,gruvbox-bright_red))))

    ;; Diffs
    `(diff-changed                      ((t (:background nil :foreground ,gruvbox-light1))))
    `(diff-added                        ((t (:background nil :foreground ,gruvbox-bright_green))))
    `(diff-removed                      ((t (:background nil :foreground ,gruvbox-bright_red))))
    ...
    ;; helm
    `(helm-M-x-key                              ((t ( :foreground ,gruvbox-bright_orange  ))))
    `(helm-action                               ((t ( :foreground ,gruvbox-white :underline t ))))
    `(helm-bookmark-addressbook                 ((t ( :foreground ,gruvbox-bright_red ))))
    ...
    `(helm-bookmark-w3m                         ((t ( :foreground ,gruvbox-bright_yellow ))))
    ...
    `(helm-candidate-number                     ((t ( :foreground ,gruvbox-bright_green ))))
    `(helm-ff-directory                         ((t ( :foreground ,gruvbox-bright_purple ))))
    ...
    `(helm-ff-prefix                            ((t ( :foreground ,gruvbox-black         :background ,gruvbox-bright_yellow))))
    `(helm-ff-symlink                           ((t ( :foreground ,gruvbox-bright_orange ))))
    `(helm-grep-cmd-line                        ((t ( :foreground ,gruvbox-bright_green ))))
    `(helm-grep-file                            ((t ( :foreground ,gruvbox-faded_purple ))))
    `(helm-grep-finish                          ((t ( :foreground ,gruvbox-turquoise4 ))))
    `(helm-grep-lineno                          ((t ( :foreground ,gruvbox-bright_orange ))))
    `(helm-grep-match                           ((t ( :foreground ,gruvbox-bright_yellow ))))
    `(helm-grep-running                         ((t ( :foreground ,gruvbox-bright_red ))))
    ...
    `(helm-match                                ((t ( :foreground ,gruvbox-bright_orange ))))
    ...
    `(company-tooltip-annotation        ((t (:foreground ,gruvbox-bright_green))))
    `(company-tooltip-selection         ((t (:foreground ,gruvbox-bright_purple))))
    `(company-tooltip-common            ((t (:foreground ,gruvbox-bright_blue :underline t))))
    `(company-tooltip-common-selection  ((t (:foreground ,gruvbox-bright_blue :underline t))))
    `(company-preview-common            ((t (:foreground ,gruvbox-bright_purple))))

    ;; Term
    `(term-color-black                  ((t (:foreground ,gruvbox-dark1))))
    `(term-color-blue                   ((t (:foreground ,gruvbox-bright_blue))))
    `(term-color-cyan                   ((t (:foreground ,gruvbox-bright_aqua))))
    `(term-color-green                  ((t (:foreground ,gruvbox-bright_green))))
    `(term-color-magenta                ((t (:foreground ,gruvbox-bright_purple))))
    `(term-color-red                    ((t (:foreground ,gruvbox-bright_red))))
    `(term-color-white                  ((t (:foreground ,gruvbox-light1))))
    `(term-color-yellow                 ((t (:foreground ,gruvbox-bright_yellow))))
    ...
    `(sml/read-only         ((t (:foreground ,gruvbox-bright_blue))))
    `(persp-selected-face   ((t (:foreground ,gruvbox-bright_orange)))))


(custom-theme-set-variables
  'gruvbox

  `(ansi-color-names-vector [,gruvbox-dark0 ,gruvbox-bright_red
    ,gruvbox-bright_green ,gruvbox-bright_yellow ,gruvbox-bright_blue
    ,gruvbox-bright_purple ,gruvbox-bright_aqua ,gruvbox-light1])))
